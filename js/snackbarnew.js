...
const kms = {
    ...
    pushInfo: (optional, button = null) => {
        ...
        const buildHTML = id => {
            ...
            }" id="${cardID}" move="0" style="z-index:${id};"><button class="exit" id="${exitID}"><i class="iconfont icon-close" style="font-size: 24px"></i></button><div class="text">${text}</div>${button ?
